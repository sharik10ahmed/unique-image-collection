...
export const images = {
  ...
  catalog: {
    p1: p1Img, p2: p2Img, p3: p3Img, p4: p4Img, p5: p5Img, p6: p6Img,
    p7: p7Img, p8: p8Img, p9: p9Img, p10: p10Img, p11: p11Img, p12: p12Img,
    c1: c1Img, c2: c2Img, c3: c3Img, c4: c4Img, c5: c5Img, c6: c6Img, c7: c7Img, c8: c8Img,
  },
};
...
export const testimonials: Testimonial[] = [
  ...
  },
  {
    ...
    name: "Madhuri Jadhav",
    location: "Mumbai",
    message: "Perfect saree for a Maharashtrian wedding. The pallu received compliments all evening.",
    rating: 5,
  },
  {
    id: "t4",
    ...
    location: "Kolhapur",
    message: "Swapnali tai personally guided me through the collection. A very warm boutique experience.",
    rating: 5,
  },
];
...
export const orders: Order[] = [
  { id: "RP-1042", customer: "Anuja Deshpande", email: "anuja@example.com", products: "Royal Peacock Paithani", amount: 24500, date: "2026-08-12", payment: "Paid", status: "Delivered" },
  { id: "RP-1043", customer: "Snehal Kulkarni", email: "snehal@example.com", products: "Pure Zari Peacock Paithani", amount: 34900, date: "2026-08-12", payment: "Paid", status: "Shipped" },
  { id: "RP-1044", customer: "Madhuri Jadhav", email: "madhuri@example.com", products: "Wedding Heritage Paithani", amount: 45900, date: "2026-08-13", payment: "Pending", status: "Confirmed" },
  { id: "RP-1045", customer: "Prajakta Shinde", email: "prajakta@example.com", products: "Rani Pink Handloom Paithani, Muniya Border Paithani", amount: 38400, date: "2026-08-13", payment: "Paid", status: "Processing" },
  { id: "RP-1046", customer: "Vaishnavi Patil", email: "vaishnavi@example.com", products: "Traditional Green Paithani", amount: 18900, date: "2026-08-14", payment: "Pending", status: "Pending" },
  { id: "RP-1047", customer: "Ketaki Joshi", email: "ketaki@example.com", products: "Kadiyal Silk Paithani", amount: 27500, date: "2026-08-14", payment: "Refunded", status: "Cancelled" },
];

export const customers: Customer[] = [
  { id: "u1", name: "Anuja Deshpande", phone: "9822011223", email: "anuja@example.com", orders: 4, spent: 96500, lastOrder: "2026-08-12", status: "Active" },
  { id: "u2", name: "Snehal Kulkarni", phone: "9730044556", email: "snehal@example.com", orders: 2, spent: 58300, lastOrder: "2026-08-12", status: "Active" },
  { id: "u3", name: "Madhuri Jadhav", phone: "9860077889", email: "madhuri@example.com", orders: 1, spent: 45900, lastOrder: "2026-08-13", status: "Active" },
  { id: "u4", name: "Prajakta Shinde", phone: "9921033445", email: "prajakta@example.com", orders: 3, spent: 74200, lastOrder: "2026-08-13", status: "Active" },
  { id: "u5", name: "Vaishnavi Patil", phone: "9028055667", email: "vaishnavi@example.com", orders: 1, spent: 18900, lastOrder: "2026-08-14", status: "Inactive" },
];
...
export const siteContent = {
  ...
  why: [
    { id: "w1", title: "Authentic Paithani Collection", text: "Every saree is sourced from trusted handloom weavers of Maharashtra." },
    { id: "w2", title: "Handcrafted Work", text: "Handmade weaving, no machine shortcuts, no printed imitations." },
    { id: "w3", title: "Traditional Maharashtrian Designs", text: "Bangdi mor, muniya, asawali and narali borders in their classic form." },
    { id: "w4", title: "Premium Silk Textiles", text: "Lustrous pure silk chosen yarn by yarn for drape and longevity." },
    { id: "w5", title: "Intricate Zari Weaving", text: "Traditional zari worked into borders and pallu over weeks of labour." },
    { id: "w6", title: "Carefully Selected Collections", text: "A curated boutique edit rather than an endless generic catalogue." },
    { id: "w7", title: "Wedding & Festive Specialities", text: "Bridal weaves and festive silks for every Maharashtrian celebration." },
    { id: "w8", title: "Boutique Shopping Experience", text: "Personal guidance from Swapnali Patil and our Pune boutique team." },
  ],
  about: {
  ...
  craftJourney: [
    { id: "j1", title: "Selecting Premium Silk", text: "Pure mulberry silk yarn is chosen for lustre, strength and drape before a single thread is dyed." },
    { id: "j2", title: "Preparing the Yarn", text: "Yarn is dyed in traditional shades, dried and wound with care to hold colour for decades." },
    { id: "j3", title: "Traditional Handloom Weaving", text: "The warp is set on a wooden handloom and the weaver begins the slow rhythm of the Paithani weave." },
    { id: "j4", title: "Creating Zari Borders", text: "Traditional zari is interlocked into the border by hand, one of the most demanding stages of the craft." },
    { id: "j5", title: "Creating Traditional Motifs", text: "Peacocks, lotuses and vines are built by hand using the tapestry technique, without any mechanical patterning." },
    { id: "j6", title: "Detailed Finishing", text: "Loose threads are secured, the pallu is finished and the saree is pressed by hand." },
    { id: "j7", title: "Final Quality Inspection", text: "Each saree is inspected for weave density, zari finish and motif symmetry before it enters our collection." },
  ],
  footer: {
    description:
