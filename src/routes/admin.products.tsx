...
export const Route = createFileRoute("/admin/products")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Add, edit and remove Paithani sarees from the storefront catalogue.",
      },
  ...
  return (
    <AdminLayout title="Products" subtitle="Manage the Paithani catalogue">
      <div className="mb-6 flex flex-wrap items-center gap-3">
        ...
        <Button className="ml-auto" onClick={() => setEditing({ ...blank })}>
          Add Product
        </Button>
      </div>
      ...
      >
        {editing ? (
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            <Field label="Fabric">
              <Input value={editing.fabric} onChange={(e) => set("fabric", e.target.value)} />
            </Field>
            <Field label="Weaving">
              <Input value={editing.weaving} onChange={(e) => set("weaving", e.target.value)} />
            </Field>
            <Field label="Zari">
              <Input value={editing.zari} onChange={(e) => set("zari", e.target.value)} />
            </Field>
            <Field label="Motif">
              <Input value={editing.motif} onChange={(e) => set("motif", e.target.value)} />
            </Field>
            <Field label="Occasion">
              <Input value={editing.occasion} onChange={(e) => set("occasion", e.target.value)} />
            </Field>
            <Field label="Work">
              <Input value={editing.work} onChange={(e) => set("work", e.target.value)} />
            </Field>
