  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Admin Dashboard | Rituraj Paithani" },
      {
        ...
        content: "Products, orders, customers and revenue at a glance.",
      },
    ],
  }),
  component: Dashboard,
          ...
          {orders.slice(0, 6).map((o) => (
            <tr key={o.id}>
              ...
              <td className="px-4 py-3">
                <Badge tone={o.payment === "Paid" ? "green" : "muted"}>{o.payment}</Badge>
              </td>
              <td className="px-4 py-3">
                <Badge
                  tone={
          ...
          {lowStock.length === 0 ? (
            <tr>
              <td colSpan={4} className="px-4 py-6 text-center text-muted-foreground">
                All weaves are comfortably stocked.
              </td>
            </tr>
          ) : (
            lowStock.map((p) => (
              <tr key={p.id}>
                ...
                <td className="px-4 py-3">
                  <Badge tone="maroon">{p.stock} left</Badge>
                </td>
