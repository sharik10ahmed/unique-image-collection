  ...
  head: () => ({
    meta: [
      { title: "New Arrival Paithani Sarees | Rituraj Paithani" },
      {
        name: "description",
        content:
          "The newest handloom Paithani weaves to reach our Pune boutique — fresh off the artisan's loom.",
      },
      { property: "og:title", content: "New Arrivals | Rituraj Paithani" },
      {
        property: "og:description",
        content: "Freshly woven Paithani sarees, newly arrived in our boutique.",
      },
    ],
  }),
      ...
      <div className="mx-auto max-w-7xl px-4 py-14 lg:px-8">
        {list.length === 0 ? (
          <EmptyState
            ...
            text="Our weavers are at the loom. New Paithani sarees arrive every few weeks."
          >
            <Link to="/shop">
